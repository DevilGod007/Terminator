    ...
    with open(pgn_path, "r") as pgn_file:
        while True:
            ...
            for move in game.mainline_moves():
                ...
                # Assign an evaluation value (you may need to replace this with real eval data)
                evaluation = board.fullmove_number  # Placeholder: using move number as a simple label
